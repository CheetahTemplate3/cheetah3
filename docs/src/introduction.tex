...
Cheetah is a Python-powered template engine and code generator.  It can be used as
a standalone utility for generating source code, HTML, reports, or it can be
combined with other systems to provide template services.  Cheetah has many
potential uses -- generating SQL, SGML or LaTeX source, PostScript, form emails,
etc. -- but web developers looking for a viable alternative to ASP, JSP, PHP and
...
database. When combined with Webware, Cheetah is a elegant, scalable, and
