...
building dynamic web sites.  (However, Cheetah is not limited to HTML: it can
produce any text-based format.)
...
\item {\bf to make it easy to separate content, graphic design, and program code.}
     ...
     able to concentrate on her specialty and to implement her changes without
     having to go through one of the others (usually a technical ''webmaster'').
