...
\item Generation, caching and filtering of output
     \begin{enumerate}
     \item plain text
     \item placeholders: \code{\$var}, \code{\$method()}
...
\item Function/method calling without outputting the return value: \code{\#call}
     \ldots
...
\item Compile-time declaration
     \begin{enumerate}
     \item define class attributes: \code{\#attribute} \ldots
