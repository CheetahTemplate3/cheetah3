...
\begin{verbatim}
$request.field.myParameter           ## Uniform Dotted Notation and autocalling.
$request.field('myParameter')        ## Using autocalling only.
$request().field('myParameter')      ## Using neither, boring.
self.request().field('myParameter')
\end{verbatim}
...
$request.hasField.myParameter  ## Is a CGI parameter defined?
