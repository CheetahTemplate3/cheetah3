...
that variable names are prefaced with a dollar sign (\$), colons (:) are
...
\code{self.} do the equivalent in Python, assuming you are in a method 
inherited by the template object.
...
Webware-specific placeholder tips are in the Webware chapter (section
\ref{webware}.
