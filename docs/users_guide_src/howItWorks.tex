...
When using a precompiled template class created by \code{cheetah-compile}, you do
{\em not} need to specify a {\bf source} or {\bf file} argument since that has
already been provided.  This allows you to instantiate a precompiled template
object without any constructor arguments if you wish:
\begin{verbatim}
