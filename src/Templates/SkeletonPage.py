...
__CHEETAH_genTime__ = 'Fri Jan  6 16:10:14 2006'
...
class SkeletonPage(_SkeletonPage):
    ...
    def writeHeadTag(self, **KWS):
        ...
        _filter = self._CHEETAH_currentFilter
    ...
    def respond(self, trans=None):
        ...
        _cacheRegionheader = self._CHEETAH_cacheRegions.get('header')
        if not _cacheRegionheader:
            _cacheRegionheader = CacheRegion()
            self._CHEETAH_cacheRegions['header'] = _cacheRegionheader
            _RECACHEheader = True
