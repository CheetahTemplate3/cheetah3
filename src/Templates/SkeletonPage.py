...
class SkeletonPage(_SkeletonPage):
    ...
    def respond(self, trans=None):
        ...
        ## START CACHE REGION: ID=header. line, col (6, 1) in the source.
...
''')
    ...
    _CHEETAH_versionTuple = (2, 0, 0, 'candidate', 5)
