...
__CHEETAH_genTime__ = 1488635266.566821
__CHEETAH_genTimestamp__ = 'Sat Mar  4 16:47:46 2017'
__CHEETAH_src__ = 'cheetah/Templates/SkeletonPage.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Jul 17 02:25:04 2009'
...
class SkeletonPage(_SkeletonPage):
    ...
    def writeHeadTag(self, **KWS):
        ...
        write(u'''<head>
<title>''')
        _v = VFFSL(SL,"title",True) # u'$title' on line 24, col 8
        if _v is not None: write(_filter(_v, rawExpr=u'$title')) # from line 24, col 8.
        write(u'''</title>
''')
        _v = VFFSL(SL,"metaTags",True) # u'$metaTags' on line 25, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$metaTags')) # from line 25, col 1.
        write(u''' 
''')
        _v = VFFSL(SL,"stylesheetTags",True) # u'$stylesheetTags' on line 26, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$stylesheetTags')) # from line 26, col 1.
        write(u''' 
''')
        _v = VFFSL(SL,"javascriptTags",True) # u'$javascriptTags' on line 27, col 1
...
''')
    ...
    def respond(self, trans=None):
        ...
        if _RECACHE_header or not _cacheItem_header.getRefreshTime():
            ...
            _v = VFFSL(SL,"docType",True) # u'$docType' on line 7, col 1
            if _v is not None: write(_filter(_v, rawExpr=u'$docType')) # from line 7, col 1.
            write(u'''
''')
            _v = VFFSL(SL,"htmlTag",True) # u'$htmlTag' on line 8, col 1
...
Copyright ''')
            _v = VFFSL(SL,"currentYr",True) # u'$currentYr' on line 12, col 11
            if _v is not None: write(_filter(_v, rawExpr=u'$currentYr')) # from line 12, col 11.
            write(u''' - ''')
            _v = VFFSL(SL,"siteCopyrightName",True) # u'$siteCopyrightName' on line 12, col 24
...
provided you remove all links and/or references to ''')
            _v = VFFSL(SL,"siteDomainName",True) # u'$siteDomainName' on line 14, col 52
            if _v is not None: write(_filter(_v, rawExpr=u'$siteDomainName')) # from line 14, col 52.
            write(u'''
However, please do not copy any content or images without permission.

''')
            _v = VFFSL(SL,"siteCredits",True) # u'$siteCredits' on line 17, col 1
...
''')
        ...
        write(u'''
''')
        _v = VFFSL(SL,"bodyTag",True) # u'$bodyTag' on line 34, col 1
...
# For more information visit https://cheetahtemplate3.github.io/
